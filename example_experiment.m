...
% stripes moving cw
protocol(1).pattern_id = 1;
protocol(1).mode_array = [0 0];
protocol(1).gain_bias_array = [72 0 0 0];
protocol(1).stimulus_array = [0.1 0.1 1 2 1 4.2];
protocol(1).pre_delay = 2;
protocol(1).post_delay = 2;

% stripes moving ccw
protocol(2).pattern_id = 1;
protocol(2).mode_array = [0 0];
protocol(2).gain_bias_array = [-72 0 0 0];
protocol(2).stimulus_array = [0.1 0.1 1 2 1 4.2];
protocol(2).pre_delay = 2;
protocol(2).post_delay = 2;

% stripe expansion
protocol(3).pattern_id = 3;
protocol(3).mode_array = [0 0];
protocol(3).gain_bias_array = [96 0 0 0];
protocol(3).stimulus_array = [0.1 0.1 1 2 1 4.2];
protocol(3).pre_delay = 2;
protocol(3).post_delay = 2;

% stripe contraction
protocol(4).pattern_id = 3;
protocol(4).mode_array = [0 0];
protocol(4).gain_bias_array = [-96 0 0 0];
protocol(4).stimulus_array = [0.1 0.1 1 2 1 4.2];
protocol(4).pre_delay = 2;
protocol(4).post_delay = 2;

% rest interval, closed loop
protocol(5).pattern_id = 1;
protocol(5).mode_array = [1 0];
protocol(5).gain_bias_array = [-40 0 0 0];
protocol(5).stimulus_array = [0 0 0 2.5 1 0];
protocol(5).pre_delay = 2;
protocol(5).post_delay = 2;
